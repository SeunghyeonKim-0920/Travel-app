          ...
          <div class="chat-msg-text" style="padding: 10px;">
            <div class="chat-msg-card">
              <div class="chat-msg-card-title">
                ...
                <span>${getText('shared_course_label')}</span>
              </div>
              <div class="chat-msg-card-desc">
                <b>${course.cityName}</b> ${getDurationOptionLabel(courseDays)}<br>
                ${getText('preference_label')}: ${prefText}
              </div>
              <button class="chat-msg-card-btn" id="${cardId}">${getText('load_itinerary')}</button>
            </div>
          </div>
        </div>
      `;
