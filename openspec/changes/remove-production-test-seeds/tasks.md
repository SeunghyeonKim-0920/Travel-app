...
- [x] 1.1 Remove mock-room seeding and use empty frontend fallbacks.
- [x] 1.2 Prune known legacy room IDs and QA titles in browser and Worker state.
- [x] 1.3 Keep root and `deploy_live` files synchronized.
