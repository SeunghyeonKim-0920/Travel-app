...
const TRANSLATIONS = {
  ko: {
    ...
    dash_stat_verified: "프로필 정보 준비 완료",
    ...
    profile_mbti: "MBTI",
    profile_sns: "SNS 계정",
    profile_verified: "프로필 정보 공개",
    profile_unverified: "프로필 정보 미공개",
    profile_verify_btn: "현재 제공하지 않는 기능",
    ...
    planner_pref_sports: "🏟️ 스포츠 경기 직관",
    planner_pref_shopping: "🛍️ 쇼핑",
    ...
    btn_download_offline: "오프라인 다운로드",
    btn_apply: "적용하기",
    ai_regen_title: "🔄 AI 코스 재생성",
    ai_regen_desc: "아래 버튼을 눌러 코스 밀도와 테마를 바로 재조정하세요.",
    regen_tag_relaxed: "💤 여유롭게",
    regen_tag_packed: "⚡ 빠듯하게",
    regen_tag_culture: "🏛️ 문화 중심",
    regen_tag_noshopping: "🚫 쇼핑 없이",
    regen_input_placeholder: "원하는 변경 사항을 입력하세요",
    duration_1: "1일차",
    duration_2: "2일차",
    duration_3: "3일차",
    duration_4: "4일차",
    ...
    age_60s: "60대+",
    age_any: "연령 무관",
    // Chat room & max people
    chat_room_default_title: "동행 소통방",
    room_max_unlimited: "인원 제한 없음",
    room_max_2: "2명",
    room_max_3: "3명",
    room_max_4: "4명",
    room_max_6: "6명",
  ...
  en: {
    ...
    nav_routeplanner: "Intercity Route Planner",
    nav_profile: "My Profile",

    // Dashboard
    dash_welcome: "Where are you going?",
    dash_subtitle: "Solo travel, planned by AI, with companions when you need them",
    dash_start_planner: "Plan AI Course",
    dash_find_companion: "Find Companions",
    dash_popular_dest: "Popular Destinations",
    dash_ref_title: "Companion Communities",
    ...
    dash_stat_verified: "Profile info ready",

    // Profile Page
    profile_title: "Profile Settings",
    profile_info: "This information is shared with other travelers during companion matching.",
    profile_name: "Name/Nickname",
    profile_age: "Age Range",
    profile_gender: "Gender",
    profile_nationality: "Nationality",
    profile_mbti: "MBTI",
    profile_sns: "SNS Account",
    profile_verified: "Profile info visible",
    profile_unverified: "Profile info hidden",
    ...
    planner_pref_activity: "🏃 Activities",
    planner_pref_sports: "🏟️ Live Sports",
    planner_pref_shopping: "🛍️ Shopping",
    planner_pref_photo: "📸 Photo Spots",
    ...
    comp_room_verify_badge: "Profile Info",
    ...
    modal_room_title_placeholder: "e.g. Anyone want to shop at The Hyundai Seoul and grab coffee?",
    modal_room_place_placeholder: "e.g. In front of The Hyundai main entrance",
    modal_room_desc_placeholder: "Add split-cost details, exact meeting point, or anything travelers should know...",
    ...
    chat_share_course_title: "Share My Itinerary",
    ...
    age_any: "Any Age",
    // Chat room & max people
    chat_room_default_title: "Companion Chat",
    room_max_unlimited: "Unlimited",
    room_max_2: "2 People",
    room_max_3: "3 People",
    room_max_4: "4 People",
    room_max_6: "6 People",
    room_max_8: "8 People",
    room_max_10: "10 People",
    // Missing UI keys
    planner_lodging_label: "Accommodation / Start Point",
    planner_lodging_none: "None (Start directly from attractions)",
    saved_trips_label: "💾 My Saved Trips",
    saved_trips_empty: "No saved trips.",
    btn_save_trip: "Save Trip",
    btn_share_trip: "Share Trip",
    btn_download_offline: "Download Offline",
    btn_apply: "Apply",
    ai_regen_title: "🔄 AI Regenerate Course",
    ai_regen_desc: "Use the buttons below to rebuild the course density and theme.",
    regen_tag_relaxed: "💤 Relaxed",
    regen_tag_packed: "⚡ Packed",
    regen_tag_culture: "🏛️ Culture-focused",
    regen_tag_noshopping: "🚫 No Shopping",
    regen_input_placeholder: "Enter your requested change",
    duration_1: "1 Day",
    duration_2: "2 Days",
    duration_3: "3 Days",
    duration_4: "4 Days",
...
const CITIES = [
  ...
  { id: "sydney", name_ko: "시드니", name_en: "Sydney", country_ko: "호주", country_en: "Australia", desc_ko: "오페라 하우스와 하버브릿지, 해변 산책로가 어우러진 호주 대표 항구 도시", desc_en: "Australian harbor city known for the Opera House, Harbour Bridge, beaches, and coastal walks." },
...
const ATTRACTIONS = {
  seoul: {
    healing: [
      { name_ko: "경복궁 & 향원정 산책", isLandmark: true, name_en: "Gyeongbokgung & Hyangwonjeong Stroll", duration: 180, desc_ko: "한적한 고궁 연못 정원 산책 및 역사 해설 청취", desc_en: "Walk through historic palace lotus gardens and listen to guide commentaries" },
      { name_ko: "북촌 찻집 차 마시는 뜰", name_en: "Bukchon Cha-Teul Hanok Tea House", duration: 90, desc_ko: "보존된 기와집 골목 구경 및 따뜻한 인삼차 시음", desc_en: "Explore preserved tile-roof alleys and taste traditional warm ginseng tea" },
    ...
    gourmet: [
      ...
      { name_ko: "익선동 동백양과점 수플레 디저트", name_en: "Ikseon-dong Dongbaek Souffle", duration: 90, desc_ko: "개조된 고택에서 몽글몽글한 팬케이크와 스페셜티 커피", desc_en: "Fluffy pancakes and specialty coffee inside a renovated heritage house" },
      { name_ko: "성수동 로우키 에스프레소 바", name_en: "Seongsu-dong Lowkey Espresso Bar", duration: 90, desc_ko: "성수 힙스터들의 성지, 감각적인 콘크리트 인테리어 맛집", desc_en: "Hot spots for Seongsu hipsters featuring unique concrete aesthetics" },
    ...
    culture: [
      ...
      { name_ko: "인사동 쌈지길 나전칠기 체험", name_en: "Insadong Ssamzigil Mother-of-Pearl Craft", duration: 120, desc_ko: "전통 나전칠기 및 단청 키링 만들기 전통 공예 체험", desc_en: "DIY traditional mother-of-pearl crafts or colorful Dancheong keyrings" },
    ...
    activity: [
      ...
      { name_ko: "홍대 레이저엑스 레이저 서바이벌", name_en: "Hongdae Lazer-X Survival", duration: 120, desc_ko: "친구들과 실내에서 땀 흘리며 대결하는 액티브 배틀존", desc_en: "Action-packed laser battles and virtual reality arenas with global peers" },
      { name_ko: "잠실 한강공원 자전거 대여 및 하이킹", name_en: "Jamsil Hangang Park Cycling & Hiking", duration: 90, desc_ko: "시원한 한강 바람을 맞으며 자전거 도로를 따라 달리는 힐링 라이딩", desc_en: "Enjoy a refreshing bike ride along the river paths at Hangang Park" },
      { name_ko: "롯데월드 어드벤처 & 자이로드롭", name_en: "Lotte World Adventure Theme Park", duration: 420, desc_ko: "실내 어트랙션 및 호수 위 매직아일랜드 아웃도어 스릴 체험", desc_en: "Indoor rollercoasters and outdoor drop towers overlooking Seokchon lake" }
    ],
    shopping: [
      ...
      { name_ko: "디올 성수 팝업 쇼룸", name_en: "Dior Seongsu Showroom", duration: 120, desc_ko: "주말마다 바뀌는 핫한 브랜드 팝업스토어 도장깨기", desc_en: "Scouting trendy local designer labels and weekly dynamic brand popups" },
      { name_ko: "명동 쇼핑 거리 & 야시장", name_en: "Myeongdong Shopping Street & Night Market", duration: 120, desc_ko: "글로벌 뷰티 브랜드 메카와 랍스터구이 등 다채로운 야식 쇼핑", desc_en: "Global K-beauty flagship stores mixed with grilled cheese lobster snack carts" },
      ...
      { name_ko: "신사 가로수길 탬버린즈 가로수길점", name_en: "Tamburins Garosu-gil Store", duration: 120, desc_ko: "가로수 가득한 감성 거리의 시그니처 프래 fragrances & 패션 편집숍 투어", desc_en: "Walk down ginkgo-tree lined avenues seeking designer perfume houses" }
    ]
  },
  jeju: {
    healing: [
  ...
  tokyo: {
    ...
    activity: [
      { name_ko: "아키하바라 애니메이션 피규어 및 메이드 카페 투어", name_en: "Akihabara Anime Figure & Maid Cafe Tour", duration: 120, desc_ko: "독창적인 서브컬처 문화의 성지에서 피규어 숍과 메이드 카페 탐방", desc_en: "Explore anime shops and experience a themed maid cafe in the heart of Akihabara" },
      { name_ko: "도쿄 디즈니씨 해양 어드벤처", name_en: "Tokyo DisneySea Ocean Attractions", duration: 540, desc_ko: "스릴 넘치는 화산 대폭발 롤러코스터와 환상적인 워터쇼", desc_en: "Unique nautical-themed theme park rides and evening volcano shows" },
  ...
  osaka: {
    ...
    activity: [
      { name_ko: "유니버설 스튜디오 재팬 (USJ) 스릴 라이드", isLandmark: true, name_en: "Universal Studios Japan Adventure", duration: 480, desc_ko: "해리포터 포비든 저니 비행 시뮬레이터 및 닌텐도 마리오카트 어트랙션", desc_en: "Immersive theme park rides featuring Mario Kart racing and flying dragons" },
      ...
      { name_ko: "오사카 신세카이 레트로 거리 먹방 투어", name_en: "Osaka Shinsekai Retro Street Food Tour", duration: 120, desc_ko: "레트로 감성의 신세카이 거리에서 쿠시카츠 등 대표 먹거리를 즐기는 푸드 투어", desc_en: "Taste legendary kushikatsu and street foods in the nostalgic retro Shinsekai district" },
    ...
    shopping: [
      ...
      { name_ko: "린쿠 프리미엄 아울렛 야외 쇼핑", name_en: "Rinku Premium Outlets Seaside Shopping", duration: 300, desc_ko: "간사이 공항 직전, 야자수 우거진 하얀 리조트 분위기 아울렛 특가 쇼핑", desc_en: "Seaside outdoor malls offering discounted sports and luxury European brands" }
    ]
  },
  paris: {
    healing: [
    ...
    culture: [
      ...
      { name_ko: "베르사유 궁전 & 거울의 방 투어", name_en: "Palace of Versailles Grand Tour", duration: 360, desc_ko: "눈부신 프랑스 절대 왕정의 정수, 대정원 분수쇼와 거울의 방 도슨트", desc_en: "Explore the golden chambers of Louis XIV and massive royal garden canals" }
    ],
    activity: [
      ...
      { name_ko: "디즈니랜드 파리 올데이 어트랙션", name_en: "Disneyland Paris Adventure Pass", duration: 480, desc_ko: "동화 속 잠자는 숲속의 미녀 성과 썬더 마운틴 롤러코스터 탑승", desc_en: "Enjoy the fairy castle, Star Wars simulators, and daily evening parades" },
    ...
    shopping: [
      ...
      { name_ko: "라발레 빌리지 명품 아울렛 쇼핑", name_en: "La Vallée Village Designer Outlet", duration: 300, desc_ko: "파리 근교 야외 쇼핑 빌리지에서 합리적인 프랑스 로컬 브랜드 사냥", desc_en: "Outdoor luxury shopping village with discounted major European labels" },
  ...
  newyork: {
    healing: [
      ...
      { name_ko: "타임스퀘어 네온 거리 산책", name_en: "Times Square Neon Walk", name_fr: "Promenade lumineuse à Times Square", name_zh: "时代广场霓虹街区漫步", name_ja: "タイムズスクエアのネオン散策", name_es: "Paseo por Times Square", duration: 90, isLandmark: true, x: -73.9855, y: 40.7580, desc_ko: "브로드웨이 극장가와 대형 전광판이 모인 뉴욕 대표 광장을 걷는 코스", desc_en: "Walk through the Broadway theater district and iconic Times Square lights", desc_fr: "Promenade classique dans le quartier des théâtres de Broadway et des panneaux lumineux.", desc_zh: "漫步百老汇剧院区和时代广场霓虹灯牌之间。", desc_ja: "ブロードウェイ劇場街と巨大電光掲示板が集まる代表的な広場を歩きます。", desc_es: "Paseo clásico por los teatros de Broadway y las luces de Times Square." },
    ...
    culture: [
      { name_ko: "월스트리트와 뉴욕증권거래소 거리", name_en: "Wall Street & New York Stock Exchange Walk", name_fr: "Wall Street et la Bourse de New York", name_zh: "华尔街与纽约证券交易所街区", name_ja: "ウォール街とニューヨーク証券取引所周辺", name_es: "Wall Street y la Bolsa de Nueva York", duration: 100, isLandmark: true, x: -74.0105, y: 40.7069, desc_ko: "월스트리트, 뉴욕증권거래소 외관, 금융지구의 역사적인 거리와 랜드마크를 걷는 코스", desc_en: "Walk Wall Street, the New York Stock Exchange exterior, and the Financial District landmarks", desc_fr: "Balade dans le quartier financier, devant Wall Street et la Bourse de New York.", desc_zh: "参观华尔街、纽约证券交易所外观和金融区地标。", desc_ja: "金融街の歴史的な通りとニューヨーク証券取引所周辺を歩きます。", desc_es: "Recorrido por Wall Street, el exterior de la Bolsa y los iconos del distrito financiero." },
    ...
    activity: [
      ...
      { name_ko: "자유의 여신상 크루즈 탑승 및 리버티 섬 방문", isLandmark: true, name_en: "Statue of Liberty Ferry", duration: 240, desc_ko: "페리를 타고 맨해튼 스카이라인을 조망하며 자유의 여신상이 있는 리버티 섬 투어", desc_en: "Board the ferry to Liberty Island and stand near the colossal copper monument" },
    ...
    shopping: [
      ...
      { name_ko: "우드버리 커먼 아울렛 메가 세일 쇼핑", name_en: "Woodbury Common Outlets", duration: 480, desc_ko: "왕복 버스를 타고 뉴욕 외곽의 거대한 할인 매장 단지에서 프리미엄 브랜드 대규모 쇼핑", desc_en: "Spend a full shopping day at hundreds of high-end brands at discount outlet rates" },
  ...
  barcelona: {
    ...
    activity: [
      ...
      { name_ko: "포르투아벤투라 테마파크 롤러코스터", name_en: "PortAventura Theme Park Ride", duration: 480, desc_ko: "유럽 최대 높이의 자이언트 롤러코스터 샴발라 탑승과 익스트림 스릴", desc_en: "Enjoy high-speed loops and drop coasters at Spain's premier amusement park" },
    ...
    shopping: [
      ...
      { name_ko: "라로카 빌리지 메가 아울렛 쇼핑", name_en: "La Roca Village Outlet Shopping", duration: 300, desc_ko: "셔틀 버스를 타고 이동하는 파스텔톤 야외 빌리지 쇼핑몰 특가 사냥", desc_en: "Explore discounted luxury European brands at an open-air village" },
  ...
  rome: {
    ...
    shopping: [
      ...
      { name_ko: "카스텔 로마노 아울렛 왕복 쇼핑", name_en: "Castel Romano Designer Outlet", duration: 300, desc_ko: "왕복 셔틀버스를 타고 이동하는 외곽 명품 쇼핑 아울렛 특가 사냥", desc_en: "Spend a half day browsing discounted premium designer goods" }
    ]
  },
  bangkok: {
    healing: [
  ...
  sydney: {
    ...
    activity: [
      ...
      { name_ko: "블루마운틴 레일웨이 급경사 열차 & 궤도", name_en: "Blue Mountains Scenic World", duration: 330, desc_ko: "세계에서 가장 가파른 52도 경사 산악 열차를 탑승하고 세자매봉 트레킹", desc_en: "Ride the glass-floored cableway and walk the boardwalk through rain forests" },
      { name_ko: "포트스테판 모래사막 샌드보딩 듄", name_en: "Port Stephens Sandboarding Dunes", duration: 360, desc_ko: "남태평양과 맞닿은 붉은 모래 사막 언덕에서 썰매 타고 급하강 스릴", desc_en: "Ride 4WD vehicles over high sand dunes and slide down at speed" },
  ...
  singapore: {
    ...
    activity: [
      ...
      { name_ko: "센토사 유니버설 스튜디오 어트랙션", name_en: "Universal Studios Singapore Sci-Fi", duration: 360, desc_ko: "트랜스포머 3D 배틀 라이드 및 미이라의 복수 지하 롤러코스터 탑승", desc_en: "Enjoy cutting-edge movie-themed rollercoasters and dynamic show stages" },
...
,
  ...
  munich: {
    ...
    activity: [
      ...
      { name_ko: "뮌헨 바이에른 국립 오페라 극장 공연 관람", name_en: "Munich Bavarian State Opera Performance", duration: 100, desc_ko: "역사와 전통을 자랑하는 국립 오페라 극장에서 클래식 공연 감상", desc_en: "Enjoy a high-class classical music or opera performance inside the historic state theatre" }
    ],
    shopping: [
      ...
      { name_ko: "디자이너 아웃렛 잉골슈타트 빌리지", name_en: "Ingolstadt Village Designer Outlet", duration: 300, desc_ko: "셔틀버스를 타고 외곽 야외 쇼핑 빌리지로 이동하여 브랜드 특가 세일 사냥", desc_en: "Explore discounted German and European luxury labels at an open-air village" },
  ...
  beijing: {
    ...
    culture: [
      { name_ko: "자금성 황실 가이드 투어", name_en: "Forbidden City Imperial Tour", duration: 240, desc_ko: "9천여 칸의 방을 가진 세계 최대 황궁의 태화전 돌계단과 황실 보물 역사 관람", desc_en: "Marvel at the golden throne halls and imperial treasure collections", isLandmark: true },
    ...
    activity: [
      { name_ko: "만리장성 팔달령 하이킹", name_en: "Great Wall of China Badaling Hike", duration: 300, desc_ko: "케이블카를 타고 가파른 산등성이를 따라 끝없이 이어진 세계 7대 불가사의 장성 하이킹", desc_en: "Climb the rugged stone watchtowers of Badaling for amazing mountain views", isLandmark: true },
...
const MOCK_COMPANION_ROOMS = [
  ...
  {
    id: 3,
    title_ko: "아키하바라 애니메이션 굿즈 숍 & 피규어 거리 동행 구해요",
    title_en: "Akihabara Anime Goods & Figure Shop Tour",
    cityId: "tokyo",
    category: "activity",
    place_ko: "아키하바라역 1번 출구 앞",
    place_en: "In front of Akihabara Station Exit 1",
    date: "2026-05-28",
    time: "15:00",
    maxPeople: 6,
    joinedCount: 5,
    ...
    desc_ko: "아키하바라 라디오회관이랑 하비천국 등 피규어/애니메이션 굿즈 숍 같이 투어할 분 구해요! 현재 5명 확정이고 마지막 한 자리 20대 유쾌하신 분 구해요! 다들 텐션 높고 친화력 좋습니다.",
    desc_en: "We are visiting Akihabara's major anime figure & hobby shops (Radio Kaikan, etc.) at 3:00 PM. We are 5 people already, looking for one more friendly person in their 20s. We have great energy!",
    status: "recruiting"
  },
  {
    id: 4,
...
const CHAT_SIMULATOR_RESPONSES = {
  ...
  3: [
    { delay: 1800, sender: "이준우", mbti: "ESTP", message_ko: "오! 환영합니다! 아키하바라 덕질 투어 준비되셨나요? 평소에 좋아하시는 애니나 캐릭터가 있으신가요?", message_en: "Oh! Welcome to our crew! Are you ready for the Akihabara hobby tour? What are your favorite anime or characters?" },
    { delay: 4000, sender: "Emma Smith", mbti: "ENTP", message_ko: "좋아하는 캐릭터 굿즈 득템할 준비 단단히 하세요! 라디오회관부터 먼저 쭉 훑어볼 예정입니다!", message_en: "Get ready to grab your favorite character merchandise! We plan to sweep through Radio Kaikan first!" }
  ],
  4: [
...
const EXTRA_CITIES_META = {
  washington: {
    ...
    core: {
      healing: { name_ko: "내셔널 몰 리플렉팅 풀", name_en: "National Mall Reflecting Pool", open: 0, close: 1440, x: -77.0425, y: 38.8893 },
      gourmet: { name_ko: "올드 에빗 그릴", name_en: "Old Ebbitt Grill", open: 660, close: 1320, x: -77.0336, y: 38.898 },
      culture: { name_ko: "미국 국회의사당", name_en: "US Capitol Building", open: 510, close: 1020, x: -77.0091, y: 38.8899, isLandmark: true },
      activity: { name_ko: "타이달 베이슨 보트선착장", name_en: "Tidal Basin Boathouse", open: 600, close: 1080, x: -77.0386, y: 38.8847 },
      shopping: { name_ko: "조지타운 엠 스트리트", name_en: "Georgetown M Street", open: 600, close: 1260, x: -77.0628, y: 38.9056 }
    }
  },
  berlin: {
  ...
  buenosaires: {
    name_ko: "부에노스아이레스", name_en: "Buenos Aires", country_ko: "아르헨티나", country_en: "Argentina",
  ...
  reykjavik: {
    name_ko: "아이슬란드 링로드", name_en: "Iceland Ring Road", country_ko: "아이슬란드", country_en: "Iceland",
    desc_ko: "레이캬비크에서 출발해 골든서클, 남부 해안, 빙하호수, 북부 도시를 잇는 아이슬란드 링로드 코스", desc_en: "A whole-Iceland Ring Road course linking Reykjavik, the Golden Circle, south coast, glacier lagoon, and northern towns.",
    core: {
      healing: { name_ko: "블루라군 지열 온천", name_en: "Blue Lagoon Geothermal Spa", open: 480, close: 1320, x: -22.4495, y: 63.8804, duration: 180 },
      gourmet: { name_ko: "레이캬비크 하버와 바야린스 베즈투", name_en: "Reykjavik Harbor & Baejarins Beztu", open: 600, close: 1440, x: -21.9406, y: 64.1480, duration: 90 },
      culture: { name_ko: "싱벨리어 국립공원", name_en: "Thingvellir National Park", open: 0, close: 1440, x: -21.1300, y: 64.2559, duration: 180, isLandmark: true },
      activity: { name_ko: "요쿨살론 빙하호수와 다이아몬드 비치", name_en: "Jokulsarlon Glacier Lagoon & Diamond Beach", open: 0, close: 1440, x: -16.2306, y: 64.0481, duration: 240, isLandmark: true },
      shopping: { name_ko: "아쿠레이리 구시가지와 항구 산책", name_en: "Akureyri Old Town & Harbor Walk", open: 540, close: 1200, x: -18.0907, y: 65.6885, duration: 120 }
    }
  },
  amsterdam: {
  ...
  hawaii: {
    ...
    core: {
      healing: { name_ko: "와이키키 해변 산책로", name_en: "Waikiki Beach Boardwalk", open: 0, close: 1440, x: -157.827, y: 21.2765 },
      gourmet: { name_ko: "듀크스 와이키키 뷰 그릴", name_en: "Duke's Waikiki Grill", open: 420, close: 1320, x: -157.8281, y: 21.2768 },
      culture: { name_ko: "이올라니 하와이 왕궁", name_en: "Iolani Palace Tour", open: 540, close: 1020, x: -157.8598, y: 21.3067, isLandmark: true },
      activity: { name_ko: "다이아몬드 헤드 하이킹 코스", name_en: "Diamond Head Summit Trail", open: 360, close: 1080, x: -157.8042, y: 21.2634 },
      shopping: { name_ko: "알라모아나 쇼핑 센터", name_en: "Ala Moana Center Mall", open: 600, close: 1260, x: -157.8437, y: 21.2913 }
    }
  },
  bali: {
    ...
    core: {
      healing: { name_ko: "테갈랄랑 계단식 논 뷰", name_en: "Tegallalang Rice Terraces", open: 420, close: 1140, x: 115.2796, y: -8.4312 },
      gourmet: { name_ko: "너티 누리스 바비큐 립스", name_en: "Naughty Nuri's BBQ Ribs", open: 660, close: 1320, x: 115.2514, y: -8.4984 },
      culture: { name_ko: "울루와투 절벽 사원", name_en: "Uluwatu Temple Cliff", open: 540, close: 1140, x: 115.0849, y: -8.829, isLandmark: true },
      activity: { name_ko: "우붓 정글 발리 스윙", name_en: "Ubud Jungle Bali Swing", open: 480, close: 1080, x: 115.2281, y: -8.4912 },
      shopping: { name_ko: "우붓 전통 예술 시장", name_en: "Ubud Traditional Art Market", open: 480, close: 1080, x: 115.2625, y: -8.5069 }
    }
  },
  cancun: {
    ...
    core: {
      healing: { name_ko: "플라야 델피네스 카리브해", name_en: "Playa Delfines Beach", open: 0, close: 1440, x: -86.7797, y: 21.0594 },
      gourmet: { name_ko: "로렌질로스 해산물 바닷가", name_en: "Lorenzillo's Lobster House", open: 720, close: 1380, x: -86.7578, y: 21.1218 },
      culture: { name_ko: "치첸이차 세계 마야 유적", name_en: "Chichen Itza Mayan Ruins", open: 480, close: 1020, x: -88.5678, y: 20.6843, isLandmark: true },
      activity: { name_ko: "엑스카레트 친환경 테마파크", name_en: "Xcaret Eco-Archaeological Park", open: 510, close: 1320, x: -87.1197, y: 20.5786 },
      shopping: { name_ko: "라 이슬라 쇼핑 빌리지", name_en: "La Isla Shopping Village", open: 600, close: 1320, x: -86.7562, y: 21.1257 }
    }
  },
  losangeles: {
    name_ko: "로스앤젤레스", name_en: "Los Angeles", country_ko: "미국", country_en: "United States",
    desc_ko: "할리우드 영화 산업과 따스한 캘리포니아 햇살이 반겨주는 천사의 도시", desc_en: "The creative capital of movies, famous for Hollywood and beaches.",
    core: {
      healing: { name_ko: "그리피스 천문대 공원", name_en: "Griffith Observatory Park", open: 300, close: 1320, x: -118.3004, y: 34.1186 },
      gourmet: { name_ko: "인앤아웃 버거 LA공항점", name_en: "In-N-Out Burger LAX", open: 630, close: 1320, x: -118.3965, y: 33.9538 },
      culture: { name_ko: "헐리우드 명예의 거리", name_en: "Hollywood Walk of Fame", open: 0, close: 1440, x: -118.3268, y: 34.1016, isLandmark: true },
      activity: { name_ko: "유니버설 스튜디오 할리우드", name_en: "Universal Studios Hollywood", open: 540, close: 1140, x: -118.3534, y: 34.1381 },
      shopping: { name_ko: "베벌리 힐스 로데오 드라이브", name_en: "Rodeo Drive Beverly Hills", open: 600, close: 1200, x: -118.4042, y: 34.0697 }
    }
  },
  sanfrancisco: {
    name_ko: "샌프란시스코", name_en: "San Francisco", country_ko: "미국", country_en: "United States",
    desc_ko: "웅장한 금문교와 로맨틱한 목조 케이블카가 오르내리는 언덕의 도시", desc_en: "Famous for the Golden Gate Bridge, cable cars, and tech hubs.",
    core: {
      healing: { name_ko: "골든 게이트 파크", name_en: "Golden Gate Park", open: 300, close: 1200, x: -122.4862, y: 37.7694 },
      gourmet: { name_ko: "피셔맨스 워프 보딘 사워도우", name_en: "Boudin Bakery Fisherman's Wharf", open: 480, close: 1260, x: -122.4175, y: 37.8074 },
      culture: { name_ko: "금문교", name_en: "Golden Gate Bridge", open: 0, close: 1440, x: -122.4783, y: 37.8199, isLandmark: true },
      activity: { name_ko: "알카트라즈 섬 감옥 투어", name_en: "Alcatraz Island Tour", open: 510, close: 1110, x: -122.423, y: 37.827 },
      shopping: { name_ko: "유니언 스퀘어 쇼핑가", name_en: "Union Square San Francisco", open: 600, close: 1260, x: -122.4074, y: 37.7879 }
    }
  },
  lasvegas: {
    name_ko: "라스베이거스", name_en: "Las Vegas", country_ko: "미국", country_en: "United States",
    desc_ko: "밤마다 화려한 네온사인과 세계 최고 수준의 쇼가 열리는 오아시스", desc_en: "The entertainment capital of the world, sparkling in the desert.",
    core: {
      healing: { name_ko: "벨라지오 분수 쇼 공원", name_en: "Bellagio Fountain Show", open: 0, close: 1440, x: -115.1767, y: 36.1126 },
      gourmet: { name_ko: "고든 램지 헬스 키친", name_en: "Gordon Ramsay Hell's Kitchen", open: 660, close: 1380, x: -115.1762, y: 36.1158 },
      culture: { name_ko: "라스베이거스 네온 박물관", name_en: "The Neon Museum", open: 540, close: 1380, x: -115.1356, y: 36.1802, isLandmark: true },
      activity: { name_ko: "그랜드 캐년 헬기 투어", name_en: "Grand Canyon Helicopter Tour", open: 420, close: 1140, x: -115.1537, y: 36.084 },
      shopping: { name_ko: "포럼 숍스 시저스 팰리스", name_en: "The Forum Shops at Caesars", open: 600, close: 1320, x: -115.1748, y: 36.1181 }
    }
  },
  chicago: {
    name_ko: "시카고", name_en: "Chicago", country_ko: "미국", country_en: "United States",
    desc_ko: "미시간호 옆 마천루와 시카고 딥디쉬 피자, 재즈 음악의 도시", desc_en: "Known for towering skyscrapers, deep-dish pizza, and jazz legacy.",
    core: {
      healing: { name_ko: "밀레니엄 파크 더 빈", name_en: "Millennium Park Cloud Gate", open: 360, close: 1380, x: -87.6227, y: 41.8827 },
      gourmet: { name_ko: "지오다노스 딥디쉬 피자", name_en: "Giordano's Deep Dish Pizza", open: 660, close: 1320, x: -87.6247, y: 41.8922 },
      culture: { name_ko: "시카고 미술관", name_en: "Art Institute of Chicago", open: 600, close: 1020, x: -87.6237, y: 41.8796, isLandmark: true },
      activity: { name_ko: "윌리스 타워 스카이덱 전망대", name_en: "Willis Tower Skydeck", open: 540, close: 1320, x: -87.6359, y: 41.8789 },
      shopping: { name_ko: "매그니피센트 마일 쇼핑가", name_en: "Magnificent Mile", open: 600, close: 1200, x: -87.6244, y: 41.897 }
    }
  },
  miami: {
    name_ko: "마이애미", name_en: "Miami", country_ko: "미국", country_en: "United States",
    desc_ko: "에메랄드빛 바다와 사우스 비치 오션 드라이브의 이국적 휴양지", desc_en: "Coastal resort city famous for beaches, nightlife, and Cuban vibes.",
    core: {
      healing: { name_ko: "사우스 비치 해안가 산책로", name_en: "South Beach Ocean Drive", open: 0, close: 1440, x: -80.1312, y: 25.7799 },
      gourmet: { name_ko: "조스 스톤 크랩 식당", name_en: "Joe's Stone Crab", open: 660, close: 1320, x: -80.1332, y: 25.7681 },
      culture: { name_ko: "비즈카야 뮤지엄 & 가든", name_en: "Vizcaya Museum & Gardens", open: 570, close: 1020, x: -80.2105, y: 25.7444, isLandmark: true },
      activity: { name_ko: "에버글레이즈 에어보트 투어", name_en: "Everglades Airboat Tour", open: 540, close: 1020, x: -80.7656, y: 25.7617 },
      shopping: { name_ko: "링컨 로드 보행자 몰", name_en: "Lincoln Road Mall", open: 600, close: 1320, x: -80.1402, y: 25.7906 }
    }
  },
  boston: {
    name_ko: "보스턴", name_en: "Boston", country_ko: "미국", country_en: "United States",
    desc_ko: "미국 독립 역사 프리덤 트레일과 하버드/MIT 지성의 유서 깊은 도시", desc_en: "One of the oldest cities in the US, rich in history and academia.",
    core: {
      healing: { name_ko: "보스턴 퍼블릭 가든", name_en: "Boston Public Garden", open: 360, close: 1380, x: -71.0708, y: 42.3542 },
      gourmet: { name_ko: "퀸시 마켓 랍스터 롤", name_en: "Quincy Market Lobster Roll", open: 600, close: 1260, x: -71.0548, y: 42.3601 },
      culture: { name_ko: "하버드 대학교 캠퍼스 야드", name_en: "Harvard University Yard", open: 0, close: 1440, x: -71.1182, y: 42.3744, isLandmark: true },
      activity: { name_ko: "프리덤 트레일 역사 투어", name_en: "Freedom Trail Walking Tour", open: 540, close: 1140, x: -71.0637, y: 42.3584 },
      shopping: { name_ko: "뉴베리 스트리트 편집숍가", name_en: "Newbury Street Boutiques", open: 600, close: 1200, x: -71.0824, y: 42.3496 }
    }
  },
  seattle: {
    name_ko: "시애틀", name_en: "Seattle", country_ko: "미국", country_en: "United States",
    desc_ko: "스페이스 니들 타워와 향긋한 스타벅스 커피의 원조가 탄생한 도시", desc_en: "The coffee capital of the US, home to Space Needle and rainy days.",
    core: {
      healing: { name_ko: "시애틀 워터프론트 공원", name_en: "Seattle Waterfront Park", open: 360, close: 1320, x: -122.343, y: 47.6074 },
      gourmet: { name_ko: "스타벅스 1호점 파이크플레이스", name_en: "Original Starbucks Pike Place", open: 360, close: 1260, x: -122.3421, y: 47.6101 },
      culture: { name_ko: "스페이스 니들 전망대", name_en: "Space Needle Tower", open: 540, close: 1380, x: -122.3493, y: 47.6205, isLandmark: true },
      activity: { name_ko: "치훌리 가든 앤 글래스 미술관", name_en: "Chihuly Garden and Glass", open: 540, close: 1200, x: -122.3486, y: 47.6214 },
      shopping: { name_ko: "시애틀 노드스트롬 본점", name_en: "Nordstrom Flagship Seattle", open: 600, close: 1200, x: -122.3364, y: 47.6121 }
    }
  },
  orlando: {
    name_ko: "올랜도", name_en: "Orlando", country_ko: "미국", country_en: "United States",
    desc_ko: "디즈니 월드와 유니버설 스튜디오 등 모험과 동심이 가득한 테마파크 도시", desc_en: "The theme park capital of the world, featuring Walt Disney World.",
    core: {
      healing: { name_ko: "레이크 에올라 공원", name_en: "Lake Eola Park", open: 360, close: 1440, x: -81.3728, y: 28.5444 },
      gourmet: { name_ko: "디즈니 월드 비어 가든", name_en: "Disney World Biergarten", open: 660, close: 1260, x: -81.5492, y: 28.3713 },
      culture: { name_ko: "케네디 우주 센터", name_en: "Kennedy Space Center", open: 540, close: 1020, x: -80.649, y: 28.5729, isLandmark: true },
      activity: { name_ko: "디즈니 매직 킹덤 신데렐라 성", name_en: "Magic Kingdom Disney World", open: 540, close: 1320, x: -81.5812, y: 28.4177 },
      shopping: { name_ko: "올랜도 빈랜드 아울렛 몰", name_en: "Orlando Vineland Premium Outlets", open: 600, close: 1320, x: -81.4937, y: 28.3872 }
    }
  },
  sandiego: {
    name_ko: "샌디에이고", name_en: "San Diego", country_ko: "미국", country_en: "United States",
    desc_ko: "미드웨이 항공모함 박물관과 캘리포니아 해변, 세계 최대 동물원의 도시", desc_en: "Seaside California city famous for USS Midway and San Diego Zoo.",
    core: {
      healing: { name_ko: "발보아 파크 엘 프라도 정원", name_en: "Balboa Park Gardens", open: 360, close: 1320, x: -117.1445, y: 32.7341 },
      gourmet: { name_ko: "필스 바비큐 갈비 식당", name_en: "Phil's BBQ San Diego", open: 660, close: 1320, x: -117.2031, y: 32.7538 },
      culture: { name_ko: "USS 미드웨이 항공모함 박물관", name_en: "USS Midway Museum", open: 600, close: 1020, x: -117.1751, y: 32.7137, isLandmark: true },
      activity: { name_ko: "샌디에이고 동물원 사파리", name_en: "San Diego Zoo", open: 540, close: 1080, x: -117.149, y: 32.7353 },
      shopping: { name_ko: "시포트 빌리지 해안 상점가", name_en: "Seaport Village Boardwalk", open: 600, close: 1260, x: -117.1706, y: 32.7093 }
    }
  }
};
...
const REAL_GOURMET_MAPPING = {
  ...
  losangeles: {
    c: [["어스 카페 웨스트 헐리우드", "Urth Caffe West Hollywood", 480, 1320], ["블루보틀 베니스 비치 카페", "Blue Bottle Coffee Venice", 420, 1140], ["리퍼블릭 커피 라운지", "Republik Coffee Lounge", 420, 1140], ["알프레드 커피 멜로즈", "Alfred Coffee Melrose", 480, 1200]],
    r: [["인앤아웃 버거 LA공항점", "In-N-Out Burger LAX", 630, 1320], ["피제리아 모짜 피자 맛집", "Pizzeria Mozza", 720, 1320], ["리퍼블릭 LA 브런치 비스트로", "Republique LA", 480, 1320], ["겔라구에차 오아하칸 전통식당", "Guelaguetza Restaurant", 660, 1320], ["프로비던스 미쉐린 파인다이닝", "Providence Fine Dining", 1080, 1380]]
  },
  sanfrancisco: {
    c: [["블루보틀 페리 빌딩 카페", "Blue Bottle Coffee Ferry Building", 420, 1140], ["사이트글라스 커피 소마", "Sightglass Coffee SoMa", 420, 1140], ["리추얼 커피 로스터스", "Ritual Coffee Roasters", 420, 1140], ["타르틴 베이커리 크루아상", "Tartine Bakery", 480, 1140]],
    r: [["보딘 사워도우 피셔맨스 워프", "Boudin Bakery Fisherman's Wharf", 480, 1260], ["하우스 오브 프라임 립", "House of Prime Rib", 1020, 1380], ["스완 오이스터 디포 굴 식당", "Swan Oyster Depot", 480, 870], ["스테이트 버드 프로비전스", "State Bird Provisions", 1020, 1320], ["게리 단코 럭셔리 프렌치", "Gary Danko", 1020, 1320]]
  },
  lasvegas: {
    c: [["삼바라떼 에스프레소 카페", "Sambalatte Coffee", 420, 1320], ["마더쉽 커피 로스터스", "Mothership Coffee Roasters", 480, 1140], ["어스 카페 윈 라스베이거스", "Urth Caffe Wynn", 360, 1380], ["장 필립 파티세리 디저트", "Jean Philippe Patisserie", 360, 1380]],
    r: [["고든 램지 헬스 키친 라스베가스", "Gordon Ramsay Hell's Kitchen", 660, 1380], ["로터스 오브 시암 태국식당", "Lotus of Siam", 660, 1320], ["몬 아미 가비 에펠탑 뷰 식당", "Mon Ami Gabi", 420, 1380], ["바자 미트 바이 호세 안드레스", "Bazaar Meat by Jose Andres", 1020, 1380], ["조엘 로부숑 최고급 프렌치", "Joël Robuchon", 1020, 1320]]
  },
  chicago: {
    c: [["인텔리젠시아 커피 밀레니엄", "Intelligentsia Coffee", 360, 1200], ["다크 매터 커피 에스프레소", "Dark Matter Coffee", 360, 1200], ["사와다 커피 말차 라떼", "Sawada Coffee", 480, 1020], ["스탠스 도넛 & 브런치 카페", "Stan's Donuts & Coffee", 360, 1260]],
    r: [["지오다노스 시카고 피자 본점", "Giordano's Deep Dish Pizza", 660, 1320], ["루 말나티스 딥디쉬 피자", "Lou Malnati's Pizzeria", 660, 1320], ["더 퍼플 피그 타파스 비스트로", "The Purple Pig", 690, 1380], ["걸 앤 더 고트 퓨전 그릴", "Girl & The Goat", 1020, 1380], ["얼리니어 미쉐린 3스타 분자요리", "Alinea", 1020, 1320]]
  },
  miami: {
    c: [["팬서 커피 윈우드 스페셜티", "Panther Coffee Wynwood", 420, 1320], ["베르사유 쿠바 빵집 디저트", "Versailles Bakery Little Havana", 480, 1380], ["바이스 시티 빈 에스프레소", "Vice City Bean", 420, 1140], ["올 데이 스페셜티 브런치", "All Day Specialty Coffee", 420, 1140]],
    r: [["조스 스톤 크랩 해산물식당", "Joe's Stone Crab", 660, 1320], ["베르사유 쿠바 전통 식당", "Versailles Restaurant", 480, 1440], ["라 마르 바이 가스톤 아쿠리오", "La Mar by Gaston Acurio", 720, 1380], ["주마 마이애미 일식 다이닝", "Zuma Miami", 720, 1380], ["프라임 112 명품 스테이크하우스", "Prime 112", 1020, 1380]]
  },
  boston: {
    c: [["조지 하웰 커피 스페셜티", "George Howell Coffee", 420, 1140], ["싱킹 컵 보스턴커먼 브런치", "Thinking Cup Common", 420, 1260], ["타테 베이커리 & 브런치 카페", "Tatte Bakery & Cafe", 420, 1200], ["오가와 커피 교토 에스프레소", "Ogawa Coffee", 420, 1140]],
    r: [["퀸시 마켓 랍스터 롤 해산물", "Quincy Market Lobster Roll", 600, 1260], ["유니언 오이스터 하우스 노포", "Union Oyster House", 660, 1320], ["리갈 시 푸즈 랍스터 구이", "Legal Sea Foods", 660, 1320], ["넵튠 오이스터 랍스터 롤", "Neptune Oyster", 660, 1260], ["레스팔리에 최고급 프렌치 다이닝", "L'Espalier", 1020, 1320]]
  },
  seattle: {
    c: [["스타벅스 1호점 파이크플레이스", "Original Starbucks Pike Place", 360, 1260], ["라 마르조코 에스프레소 바", "La Marzocco Cafe", 420, 1140], ["엘름 커피 로스터스 드립", "Elm Coffee Roasters", 420, 1140], ["빅트롤라 커피 로스터스", "Victrola Coffee Roasters", 420, 1140]],
    r: [["파이크 플레이스 피시 마켓", "Pike Place Fish Market", 420, 1140], ["더 핑크 도어 이탈리안 비스트로", "The Pink Door", 690, 1380], ["메트로폴리탄 그릴 스테이크", "Metropolitan Grill", 660, 1380], ["캔리스 오션 뷰 파인다이닝", "Canlis", 1020, 1380], ["딘타이펑 시애틀 만두전문점", "Din Tai Fung Seattle", 660, 1320]]
  },
  orlando: {
    c: [["리니지 커피 로스팅 스페셜티", "Lineage Coffee Roasting", 420, 1140], ["폭스테일 커피 에스프레소", "Foxtail Coffee Co.", 420, 1320], ["크래프트 & 커먼 브런치 카페", "Craft & Common", 420, 1140], ["스타더스트 비디오 & 커피 펍", "Stardust Video & Coffee", 480, 1320]],
    r: [["디즈니 월드 비어 가든 런치", "Disney World Biergarten", 660, 1260], ["더 래버너스 피그 그릴 비스트로", "The Ravenous Pig", 660, 1320], ["프라토 윈터파크 이탈리안", "Prato Winter Park", 660, 1320], ["불 & 베어 고급 스테이크하우스", "Bull & Bear Steakhouse", 1020, 1380], ["빅토리아 & 앨버트 파인다이닝", "Victoria & Albert's", 1020, 1320]]
  },
  sandiego: {
    c: [["베터 버즈 커피 힐크레스트 라떼", "Better Buzz Coffee Hillcrest", 360, 1260], ["버드 락 커피 로스터스", "Bird Rock Coffee Roasters", 360, 1140], ["코파 비다 브런치 에스프레소", "Copa Vida", 420, 1140], ["레스타츠 커피 하우스 24시간", "Lestat's Coffee House", 0, 1440]],
    r: [["필스 바비큐 갈비 숯불구이", "Phil's BBQ San Diego", 660, 1320], ["더 프라도 발보아 파크 가든식당", "The Prado at Balboa Park", 690, 1320], ["호다즈 오션비치 수제 버거", "Hodad's Ocean Beach", 660, 1320], ["주니퍼 & 아이비 모던 아메리칸", "Juniper & Ivy", 1020, 1380], ["애디슨 리조트 파인다이닝", "Addison Restaurant", 1020, 1320]]
  }
};
...
for (const cid in EXTRA_CITIES_META) {
  if (['doha', 'luxembourg'].includes(cid)) continue;
  const data = EXTRA_CITIES_META[cid];
  
  if (!CITIES.some(c => c.id === cid)) {
    CITIES.push({
      id: cid,
  ...
  categories.forEach(cat => {
    ...
    const name = ((coreItem.name_ko || '') + ' ' + (coreItem.name_en || '')).toLowerCase();
    if (name.includes('디즈니') || name.includes('disney') || name.includes('유니버설') || name.includes('universal') || name.includes('테마파크') || name.includes('theme park') || name.includes('놀이공원') || name.includes('amusement')) {
      defaultDuration = 480;
    } else if (name.includes('아울렛') || name.includes('outlet') || name.includes('벼룩시장') || name.includes('flea market') || name.includes('쇼핑몰') || name.includes('mall') || name.includes('백화점') || name.includes('department store')) {
      defaultDuration = 300;
    } else if (name.includes('박물관') || name.includes('museum') || name.includes('미술관') || name.includes('gallery')) {
      defaultDuration = 180;
    } else if (name.includes('동물원') || name.includes('zoo') || name.includes('사파리') || name.includes('safari')) {
      defaultDuration = 300;
    } else if (name.includes('우주 센터') || name.includes('space center')) {
      defaultDuration = 300;
    } else if (name.includes('하이킹') || name.includes('hike') || name.includes('트레킹') || name.includes('trekking') || name.includes('국립공원') || name.includes('national park')) {
      defaultDuration = 180;
    }
    ...
    ATTRACTIONS[cid][cat].push({
      ...
      duration: coreItem.duration || defaultDuration,
  ...
  if (mapping) {
    ...
    mapping.c.forEach((c, idx) => {
      let x = core.gourmet.x + (idx % 2 === 0 ? 0.015 : -0.015);
      let y = core.gourmet.y + (idx < 2 ? 0.015 : -0.015);
    ...
    mapping.r.forEach((r, idx) => {
      let x = core.gourmet.x + (idx % 2 === 0 ? 0.025 : -0.025);
      let y = core.gourmet.y + (idx < 3 ? -0.025 : 0.025);
      x = Math.max(-180, Math.min(180, x));
      y = Math.max(-90, Math.min(90, y));
...
if (ATTRACTIONS.reykjavik) {
  ATTRACTIONS.reykjavik.healing.push(
    { name_ko: "셀랴란드스포스 폭포", name_en: "Seljalandsfoss Waterfall", duration: 120, isLandmark: true, x: -19.9886, y: 63.6156, open: 0, close: 1440, desc_ko: "남부 해안 링로드에서 폭포 뒤편 산책로까지 둘러보는 대표 폭포", desc_en: "Classic south coast Ring Road waterfall with a walk behind the cascade." },
    { name_ko: "스코가포스 폭포", name_en: "Skogafoss Waterfall", duration: 120, isLandmark: true, x: -19.5114, y: 63.5321, open: 0, close: 1440, desc_ko: "거대한 물줄기와 전망 계단으로 유명한 아이슬란드 남부 대표 폭포", desc_en: "Major south Iceland waterfall with a powerful curtain and viewpoint stairs." },
    { name_ko: "레이니스피아라 검은 모래 해변", name_en: "Reynisfjara Black Sand Beach", duration: 120, isLandmark: true, x: -19.0443, y: 63.4043, open: 0, close: 1440, desc_ko: "주상절리와 검은 모래, 대서양 파도가 만나는 남부 해안 명소", desc_en: "South coast black sand beach known for basalt columns and Atlantic surf." }
  );
  ATTRACTIONS.reykjavik.culture.push(
    { name_ko: "게이시르 지열 지대", name_en: "Geysir Geothermal Area", duration: 120, isLandmark: true, x: -20.3000, y: 64.3104, open: 0, close: 1440, desc_ko: "골든서클의 간헐천과 지열 지대를 둘러보는 필수 코스", desc_en: "Golden Circle geothermal area with active geysers and steaming pools." },
    { name_ko: "굴포스 폭포", name_en: "Gullfoss Waterfall", duration: 120, isLandmark: true, x: -20.1200, y: 64.3271, open: 0, close: 1440, desc_ko: "빙하수가 협곡으로 떨어지는 골든서클 대표 폭포", desc_en: "Golden Circle waterfall where glacial water drops into a dramatic canyon." },
    { name_ko: "미바튼 호수 지열 지대", name_en: "Lake Myvatn Geothermal Area", duration: 180, isLandmark: true, x: -16.9961, y: 65.6039, open: 0, close: 1440, desc_ko: "북부 아이슬란드의 화산 지형, 용암 대지, 지열 풍경을 보는 코스", desc_en: "North Iceland volcanic lake area with lava fields and geothermal scenery." }
  );
  ATTRACTIONS.reykjavik.activity.push(
    { name_ko: "스카프타펠 빙하 전망 하이킹", name_en: "Skaftafell Glacier View Hike", duration: 180, isLandmark: true, x: -16.9667, y: 64.0167, open: 480, close: 1080, desc_ko: "바트나요쿨 국립공원 안에서 빙하 전망 산책로를 걷는 링로드 핵심 일정", desc_en: "Vatnajokull National Park hike with accessible glacier viewpoints." },
    { name_ko: "고다포스 폭포", name_en: "Godafoss Waterfall", duration: 90, isLandmark: true, x: -17.5496, y: 65.6828, open: 0, close: 1440, desc_ko: "북부 링로드에서 들르는 말굽형 폭포와 강변 전망 포인트", desc_en: "North Iceland horseshoe-shaped waterfall and riverside viewpoint." },
