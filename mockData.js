...
const CITIES = [
  ...
  { id: "sydney", name_ko: "시드니", name_en: "Sydney", country_ko: "호주", country_en: "Australia", desc_ko: "오�];��시", desc_en: "High-altitude capital of Colombia famous for Gold Museum." },
  ...
  { id: "luxembourg", name_ko: "룩셈부르크", name_en: "Luxembourg", country_ko: "룩셈부르크", country_en: "Luxembourg", desc_ko: "요새화된 협곡 성곽과 현대식 EU 기구들이 조화를 이루는 도시", desc_en: "Fortified canyon capital city of Luxembourg." },
...
const ATTRACTIONS = {
  ...
  newyork: {
    ...
    shopping: [
      ...
      { name_ko: "우드버리 커먼 아울렛 메가 세일 쇼핑", name_en: "Woodbury Common Outlets", duration: 300, desc_ko: "왕복 버스를 타고 뉴욕 외곽의 거대한 할인 매장 단지에서 프리미엄 브랜드 대규모 쇼핑", desc_en: "Spend a half day shopping at hundreds of high-end brands at discount outlet rates" },
...
const EXTRA_CITIES_META = {
  ...
  neworleans: {
    name_ko: "뉴올리언스", name_en: "New Orleans", country_ko: "미국", country_en: "United States",
    desc_ko: "재즈 선율이 흐르는 프렌치 쿼터와 고소한 카페 두 몽드 베네의 도시", desc_en: "Famous for jazz heritage, Cajun cuisine, and Mardi Gras festivals.",
    core: {
      healing: { name_ko: "시티 파크 거대 참나무 정원", name_en: "New Orleans City Park", open: 360, close: 1380, x: -90.0962, y: 29.9865 },
      gourmet: { name_ko: "카페 두 몽드 프렌치 마켓", name_en: "Cafe Du Monde Beignets", open: 0, close: 1440, x: -90.0617, y: 29.9575 },
      culture: { name_ko: "프렌치 쿼터 잭슨 광장", name_en: "French Quarter Jackson Square", open: 0, close: 1440, x: -90.063, y: 29.9574, isLandmark: true },
      activity: { name_ko: "스웜프 늪지 악어 보트 투어", name_en: "New Orleans Swamp Tour", open: 540, close: 1020, x: -90.1167, y: 29.8333 },
      shopping: { name_ko: "프렌치 마켓 전통 상점가", name_en: "French Market New Orleans", open: 600, close: 1140, x: -90.0597, y: 29.9583 }
    }
  },
  sandiego: {
...
const REAL_GOURMET_MAPPING = {
  ...
  neworleans: {
    c: [["카페 두 몽드 프랑스 마켓 베네", "Cafe Du Monde French Market", 0, 1440], ["스핏파이어 스페셜티 에스프레소", "Spitfire Coffee", 480, 1140], ["프렌치 트럭 커피 로스터리", "French Truck Coffee", 420, 1140], ["카페 베네 로열 스트리트 디저트", "Cafe Beignet Royal Street", 420, 1320]],
    r: [["커맨더스 팰리스 숲속 레스토랑", "Commander's Palace", 690, 1320], ["갈라투아 정통 크레올 파인다이닝", "Galatoire's Restaurant", 690, 1320], ["코숑 케이준 바비큐 그릴", "Cochon Restaurant", 660, 1320], ["아크메 오이스터 하우스 생굴", "Acme Oyster House", 660, 1320], ["브레넌스 핑크 저택 레스토랑", "Brennan's", 540, 1320]]
  },
  sandiego: {
...
for (const cid in EXTRA_CITIES_META) {
  ...
  const cultureTemplates = [
    { name_ko: "시립 현대 미술관", name_en: "Municipal Museum of Contemporary Art", duration: 120, dx: -0.3, dy: 0.3, open: 600, close: 1080 },
    { name_ko: "역사 박물관", name_en: "History Museum", duration: 120, dx: 0.2, dy: 0.1, open: 540, close: 1080 },
    { name_ko: "중앙 대성당", name_en: "Central Cathedral", duration: 90, dx: 0.4, dy: -0.2, open: 540, close: 1080 },
    { name_ko: "조각공원", name_en: "Sculpture Park", duration: 90, dx: -0.2, dy: -0.3, open: 480, close: 1080 }
  ];
  const activityTemplates = [
    { name_ko: "마리나 요트 투어", name_en: "Marina Yacht Tour", duration: 120, dx: 0.5, dy: 0.5, open: 540, close: 1200 },
    { name_ko: "공원 자전거 하이킹", name_en: "Park Bike Stroll", duration: 120, dx: -0.4, dy: -0.4, open: 480, close: 1140 },
    { name_ko: "종합 테마파크", name_en: "Amusement Theme Park", duration: 300, dx: 0.1, dy: 0.2, open: 600, close: 1260 },
    { name_ko: "레이싱 카트 체험", name_en: "Go-Kart Circuit", duration: 90, dx: -0.2, dy: 0.1, open: 600, close: 1200 }
  ];
  const shoppingTemplates = [
    { name_ko: "중앙 쇼핑 스트리트", name_en: "Central Shopping Street", duration: 180, dx: -0.1, dy: -0.2, open: 600, close: 1260 },
    { name_ko: "로컬 벼룩시장", name_en: "Local Flea Market", duration: 120, dx: 0.3, dy: 0.2, open: 540, close: 1140 },
    { name_ko: "쇼핑 아케이드", name_en: "Shopping Arcade", duration: 150, dx: -0.2, dy: 0.3, open: 600, close: 1200 },
    { name_ko: "로컬 야시장", name_en: "Local Night Market", duration: 180, dx: 0.2, dy: -0.3, open: 1020, close: 1380 }
  ];
